      ...
      rules: [
        {
          ...
          'for': '15m',
          expr: |||
            min by (%s) (cortex_ring_members{namespace="cortex", state="Unhealthy", name="ingester"}) > 0
        ...
        },
        {
          ...
          expr: |||
            100 * sum by (%(group_by)s, job, route) (rate(cortex_request_duration_seconds_count{namespace="cortex", status_code=~"5..",route!~"%(excluded_routes)s"}[1m]))
              /
            sum by (%(group_by)s, job, route) (rate(cortex_request_duration_seconds_count{namespace="cortex", route!~"%(excluded_routes)s"}[1m]))
              > 1
          ||| % {
        ...
        },
        {
          ...
          expr: |||
            %(group_prefix_jobs)s_route:cortex_request_duration_seconds:99quantile{namespace="cortex", route!~"%(excluded_routes)s"}
               >
        ...
        },
        {
          ...
          expr: |||
            100 * rate(cortex_table_manager_sync_duration_seconds_count{namespace="cortex", status_code!~"2.."}[15m])
              /
            rate(cortex_table_manager_sync_duration_seconds_count{namespace="cortex"}[15m])
              > 10
          |||,
          'for': '30m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            count(count by(%s, job, sha256) (cortex_runtime_config_hash{namespace="cortex"})) without(sha256) > 1
          ||| % $._config.alert_aggregation_labels,
          'for': '1h',
          labels: {
            severity: 'critical',
        ...
        },
        {
          ...
          expr: |||
            ...
            cortex_runtime_config_last_reload_successful{namespace="cortex"} == 0
          |||,
        ...
        },
        {
          ...
          expr: |||
            sum by (%s) (cortex_query_frontend_queue_length{namespace="cortex"}) > 1
          ||| % $._config.alert_aggregation_labels,
        ...
        },
        {
          ...
          expr: |||
            sum by (%s) (cortex_query_scheduler_queue_length{namespace="cortex"}) > 1
          ||| % $._config.alert_aggregation_labels,
          'for': '5m',  // We don't want to block for longer.
          labels: {
            severity: 'critical',
        ...
        },
        {
          ...
          expr: |||
            changes(process_start_time_seconds{namespace="cortex", job=~".+(cortex|ingester.*)"}[30m]) >= 2
          |||,
          labels: {
        ...
        },
        {
          ...
          expr: |||
            max_over_time(cortex_shutdown_duration_seconds_count{namespace="cortex", op="transfer",status!="success"}[15m])
          |||,
          'for': '5m',
          labels: {
            severity: 'critical',
        ...
        },
        {
          ...
          expr: |||
            (time() - cortex_oldest_unflushed_chunk_timestamp_seconds{namespace="cortex"} > 36000)
              and
            (cortex_oldest_unflushed_chunk_timestamp_seconds{namespace="cortex"} > 0)
          |||,
          'for': '5m',
          labels: {
            severity: 'warning',
        ...
        },
        {
          ...
          expr: |||
            (
              sum by(%s, pod, status_code, kv_name) (rate(cortex_kv_request_duration_seconds_count{namespace="cortex", status_code!~"2.+"}[1m]))
              /
              sum by(%s, pod, status_code, kv_name) (rate(cortex_kv_request_duration_seconds_count{namespace="cortex"}[1m]))
            )
        ...
        },
        {
          ...
          expr: |||
            process_memory_map_areas{namespace="cortex", job=~".+(cortex|ingester.*|store-gateway)"} / process_memory_map_areas_limit{namespace="cortex", job=~".+(cortex|ingester.*|store-gateway)"} > 0.8
          |||,
          'for': '5m',
          labels: {
            severity: 'critical',
      ...
      rules: [
        {
          ...
          expr: |||
            (
                (cortex_ingester_memory_series{namespace="cortex"} / ignoring(limit) cortex_ingester_instance_limits{namespace="cortex", limit="max_series"})
                and ignoring (limit)
                (cortex_ingester_instance_limits{namespace="cortex", limit="max_series"} > 0)
            ) > 0.8
          |||,
          'for': '3h',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            (
                (cortex_ingester_memory_users{namespace="cortex"} / ignoring(limit) cortex_ingester_instance_limits{namespace="cortex", limit="max_tenants"})
                and ignoring (limit)
                (cortex_ingester_instance_limits{namespace="cortex", limit="max_tenants"} > 0)
            ) > 0.7
          |||,
          'for': '5m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            (
                (cortex_distributor_inflight_push_requests{namespace="cortex"} / ignoring(limit) cortex_distributor_instance_limits{namespace="cortex", limit="max_inflight_push_requests"})
                and ignoring (limit)
                (cortex_distributor_instance_limits{namespace="cortex", limit="max_inflight_push_requests"} > 0)
            ) > 0.8
          |||,
          'for': '5m',
          labels: {
      ...
      rules: [
        {
          ...
          expr: |||
            increase(cortex_ingester_wal_corruptions_total{namespace="cortex"}[5m]) > 0
          |||,
          labels: {
            severity: 'critical',
          },
        ...
        },
        {
          ...
          expr: |||
            increase(cortex_ingester_checkpoint_creations_failed_total{namespace="cortex"}[10m]) > 0
          |||,
          labels: {
            severity: 'warning',
          },
        ...
        },
        {
          ...
          alert: 'CortexCheckpointCreationFailed',
          expr: |||
            increase(cortex_ingester_checkpoint_creations_failed_total{namespace="cortex"}[1h]) > 1
          |||,
          labels: {
            severity: 'critical',
          },
        ...
        },
        {
          ...
          expr: |||
            increase(cortex_ingester_checkpoint_deletions_failed_total{namespace="cortex"}[10m]) > 0
          |||,
          labels: {
            severity: 'warning',
          },
        ...
        },
        {
          ...
          alert: 'CortexCheckpointDeletionFailed',
          expr: |||
            increase(cortex_ingester_checkpoint_deletions_failed_total{namespace="cortex"}[2h]) > 1
          |||,
          labels: {
            severity: 'critical',
          },
      ...
      rules: [
        {
          ...
          expr: |||
            ...
            * on(%s) group_left max by(%s) (cortex_build_info{namespace="cortex"})
          ||| % [$._config.alert_aggregation_labels, $._config.alert_aggregation_labels],
          'for': '15m',
          labels: {
            severity: 'warning',
      ...
      rules: [
        {
          ...
          expr: |||
            (
              4 *
              sum by (%s) (cortex_ingester_memory_series{namespace="cortex"} * cortex_ingester_chunk_size_bytes_sum{namespace="cortex"} / cortex_ingester_chunk_size_bytes_count{namespace="cortex"})
               / 1e9
            )
              >
            (
              sum by (%s) (memcached_limit_bytes{job=~".+/memcached", namespace="cortex"}) / 1e9
            )
          ||| % [$._config.alert_aggregation_labels, $._config.alert_aggregation_labels],
          'for': '15m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            avg by (%s) (cortex_ingester_memory_series{namespace="cortex"}) > 1.6e6
          ||| % [$._config.alert_aggregation_labels],
          'for': '2h',
          labels: {
            severity: 'warning',
        ...
        },
        {
          ...
          expr: |||
            avg by (%s) (rate(cortex_ingester_ingested_samples_total{namespace="cortex"}[1m])) > 80e3
          ||| % $._config.alert_aggregation_labels,
          'for': '15m',
          labels: {
            severity: 'warning',
        ...
        },
        {
          ...
          expr: |||
            (
              container_memory_working_set_bytes{namespace="cortex", container="ingester"}
                /
              container_spec_memory_limit_bytes{namespace="cortex", container="ingester"}
            ) > 0.65
          |||,
          'for': '15m',
          labels: {
      ...
      rules: [
        {
          ...
          expr: |||
            100 * (
            sum by (%s, instance) (rate(cortex_ruler_write_requests_failed_total{namespace="cortex"}[1m]))
              /
            sum by (%s, instance) (rate(cortex_ruler_write_requests_total{namespace="cortex"}[1m]))
            ) > 1
          ||| % [$._config.alert_aggregation_labels, $._config.alert_aggregation_labels],
          'for': '5m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            100 * (
            sum by (%s, instance) (rate(cortex_ruler_queries_failed_total{namespace="cortex"}[1m]))
              /
            sum by (%s, instance) (rate(cortex_ruler_queries_total{namespace="cortex"}[1m]))
            ) > 1
          ||| % [$._config.alert_aggregation_labels, $._config.alert_aggregation_labels],
          'for': '5m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            sum by (%s, instance, rule_group) (rate(cortex_prometheus_rule_group_iterations_missed_total{namespace="cortex"}[1m]))
              /
            sum by (%s, instance, rule_group) (rate(cortex_prometheus_rule_group_iterations_total{namespace="cortex"}[1m]))
              > 0.01
          ||| % [$._config.alert_aggregation_labels, $._config.alert_aggregation_labels],
          'for': '5m',
          labels: {
        ...
        },
        {
          ...
          expr: |||
            sum by (%s, job) (rate(cortex_ruler_ring_check_errors_total{namespace="cortex"}[1m]))
               > 0
          ||| % $._config.alert_aggregation_labels,
          'for': '5m',
          labels: {
      ...
      rules: [
        {
          ...
          expr:
            |||
              memberlist_client_cluster_members_count{namespace="cortex"}
                != on (%s) group_left
              sum by (%s) (up{job=~".+/%s"})
